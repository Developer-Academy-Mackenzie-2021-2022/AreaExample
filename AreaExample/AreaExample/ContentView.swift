...
//                            .padding()
                        ...
                        Text("Exemplo 3")
                            ...
                            .bold()
                            .padding()
                        AreaGraph(datas: [[10,15,60,5], [60,70,23,10]], titulo: "Amarelo e Roxo", legendas: ["Roxo", "Amarelo"], nomeseixoX: ["0","1","2","4"], colors: [Color.purple, Color.yellow], marginDireita: 40, marginEsquerda: 100, alturaGrafico: 300, quantidadeY: 10)
